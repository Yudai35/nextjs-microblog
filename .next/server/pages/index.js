...
/* harmony import */ var _lib_post__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7675);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_lib_post__WEBPACK_IMPORTED_MODULE_5__]);
_lib_post__WEBPACK_IMPORTED_MODULE_5__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
async function getStaticProps() {
    const allPostsData = (0,_lib_post__WEBPACK_IMPORTED_MODULE_5__/* .getPostsData */ .x0)(); // id, title, date, thumbnail
    console.log(allPostsData);
    // getStaticProps特有のreturn
    return {
        props: {
            allPostsData
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,675,476], () => (__webpack_exec__(3678)));
